    ...
    public static void main(String[] args) {
        ...
        switch (testInt) {
            ...
            case 5:
                r = 2;
                break;
            default:  //if default is skipped then it isn't fully initialized
                r = 3;
        }
        ...
        do {
            s = t++;  // runs at least once - so s is initialized
        } while (t < 1);
        ...
        while (true) {
            u = v++; // u is only seen as initialized by the compiler, if the while condition is staticly true (example v < 1 instead true)
            break;
        }
